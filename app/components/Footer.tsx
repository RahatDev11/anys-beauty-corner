...
const Footer = () => {
    ...
    const LinkList: React.FC<{ isOpen: boolean, children: React.ReactNode }> = ({ isOpen, children }) => {
            ...
            <div className="container mx-auto px-4 max-w-6xl">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
                    <div>
                        ...
                        <LinkList isOpen={importantLinksOpen}>
                    ...
                    <div>
                        ...
                        <LinkList isOpen={categoriesOpen}>
