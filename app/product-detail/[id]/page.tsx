...
const ProductDetail = () => {
    ...
    return (
        <div className="min-h-screen" style={{ backgroundColor: 'var(--home-bg-color, #f3f4f6)' }}>
            <main className="p-4 pt-24 md:pt-28 max-w-4xl mx-auto pb-24" style={{ backgroundColor: 'var(--home-bg-color, #f3f4f6)' }}>
                <div className="bg-white rounded-lg shadow-sm p-6" style={{ backgroundColor: 'var(--home-bg-color, #ffffff)' }}>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                            {relatedProducts.slice(0, 4).map((relatedProduct) => (
                                <ProductCard 
                                    ...
                                    product={{
                                        ...relatedProduct,
                                        image: relatedProduct.images?.[0] || '/placeholder-image.jpg' // Pass the first image as the main image
                                    }}
                                    addToCart={() => { /* Placeholder for logic */ }}
                                    removeFromCart={() => { /* Placeholder for logic */ }}
                                    updateCartQuantity={() => { /* Placeholder for logic */ }}
                                    buyNow={() => { /* Placeholder for logic */ }}
                                    showProductDetail={(id: string) => router.push(`/product-detail/${id}`)}
                                />
                            ))}
                        </div>
                    </section>
            ...
            {/* Fixed Order Bar */}
            {totalItems > 0 && (
                <div className="fixed bottom-0 left-0 w-full bg-white p-4 shadow-lg z-40 border-t border-gray-200" style={{ backgroundColor: 'var(--home-bg-color, #ffffff)' }}>
