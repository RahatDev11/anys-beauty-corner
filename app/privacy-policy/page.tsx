...
const PrivacyPolicyPage = () => {
  return (
    <main className="p-4 pt-24 md:pt-28 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-center text-lipstick-dark mb-6">Privacy Policy</h1>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          The types of personal information we may collect include your name, email address, shipping address, billing address, phone number, and payment information.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside text-gray-700 leading-relaxed mb-4 ml-4">
          ...
          <li>Send you marketing and promotional communications (if you opt-in)</li>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          You have the right to access, update, or delete your personal information. You can also object to the processing of your personal data, ask us to restrict the processing of your personal data, or request portability of your personal data. To exercise these rights, please contact us using the contact information provided below.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside text-gray-700 leading-relaxed mb-4 ml-4">
          <li>By email: info@anysbeautycorner.com</li>
          <li>By phone: +880 1931-866636</li>
        </ul>
      </section>
    </main>
  );
